        ...
        return (
            <div>
                ...
                <form onSubmit={signupFn}>
                    ...
                    <div className="signup-btn text-center text-info" onClick={toggleSignup}style={{cursor:'pointer'}}>Already have an Account ? Login</div>
        ...
        return (
            <div >
                ...
                <form onSubmit={loginFn}>
                    ...
                    <div className="signup-btn text-right text-info" onClick={toggleSignup} style={{cursor:'pointer'}}>Dont have an Account ? Signup</div>
                    <div className="auth-error-msg text-danger text-center">{message}</div>
                </form>
            </div>
        )
